 ...
 */
package com.testproject.kaera.ringtestapp.changehandler.transitions;
...
import static com.testproject.kaera.ringtestapp.util.AnimUtils.NoPauseAnimator;
import static com.testproject.kaera.ringtestapp.util.AnimUtils.getFastOutLinearInInterpolator;
import static com.testproject.kaera.ringtestapp.util.AnimUtils.getFastOutSlowInInterpolator;
import static com.testproject.kaera.ringtestapp.util.AnimUtils.getLinearOutSlowInInterpolator;
...
public class FabTransform extends Transition {
    ...
    public Animator createAnimator(final ViewGroup sceneRoot,
        ...
        final Interpolator fastOutSlowInInterpolator = getFastOutSlowInInterpolator();
        ...
        if (fromFab) {
            ...
            circularReveal.setInterpolator(getFastOutLinearInInterpolator());
        } else {
            circularReveal = ViewAnimationUtils.createCircularReveal(view,
                    view.getWidth() / 2,
                    view.getHeight() / 2,
                    ...
                    endBounds.width() / 2);
            circularReveal.setInterpolator(getLinearOutSlowInInterpolator());
